export const BoardIcon = () => (
	<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<g clipPath='url(#clip0_38_492)'>
			...
			/>
			<path d='M5.25 9.75H18.75' stroke='#131313' strokeLinecap='round' strokeLinejoin='round' />
			<path d='M9.75 18.75V9.75' stroke='#131313' strokeLinecap='round' strokeLinejoin='round' />
		</g>
		<defs>
...
export const DashboardIcon = () => (
	<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path d='M10 3H3V10H10V3Z' stroke='#131313' strokeLinecap='round' strokeLinejoin='round' />
		<path d='M21 3H14V10H21V3Z' stroke='#131313' strokeLinecap='round' strokeLinejoin='round' />
		<path d='M21 14H14V21H21V14Z' stroke='#131313' strokeLinecap='round' strokeLinejoin='round' />
		<path d='M10 14H3V21H10V14Z' stroke='#131313' strokeLinecap='round' strokeLinejoin='round' />
	</svg>
)

export const AnalysticIcon = () => (
	<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path
...
export const LoupeIcon = () => (
	<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path
			...
			strokeLinejoin='round'
		/>
		<path d='M20 20L16.1333 16.1334' stroke='#707070' stroke-width='1.5' strokeLinecap='round' strokeLinejoin='round' />
	</svg>
)
...
export const LogOutIcon = () => (
	<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		...
		/>
		<path d='M16 17L21 12L16 7' stroke='#131313' stroke-linecap='round' stroke-linejoin='round' />
		<path d='M21 12H9' stroke='#131313' stroke-linecap='round' stroke-linejoin='round' />
	</svg>
)

export const PlusIcon = ({color = '#131313'}) => (
	<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path d='M12 5V19' stroke={color} stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
		<path d='M5 12H19' stroke={color} stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
	</svg>
)
